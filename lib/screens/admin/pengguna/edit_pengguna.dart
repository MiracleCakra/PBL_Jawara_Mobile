...
class _EditPenggunaScreenState extends State<EditPenggunaScreen> {
  ...
  // ✅ DAFTAR ROLE LENGKAP DIPINDAHKAN KE SINI
  ...
  void initState() {
    ...
    // Pastikan role yang diterima ada dalam daftar _allRoles, jika tidak set null.
    if (_allRoles.contains(widget.userData['role'])) {
          ...
          child: Column(
            ...
            children: [
              ...
              _buildDropdownField(
                label: 'Role',
                value: _role,
                // ✅ MENGGUNAKAN DAFTAR LENGKAP _allRoles

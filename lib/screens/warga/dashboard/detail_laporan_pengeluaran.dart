...
class LaporanDetailPengeluaranScreen extends StatelessWidget {
  final TransaksiModel data;

  LaporanDetailPengeluaranScreen({super.key, required this.data})
      : assert(data.tipeTransaksi == 'Pengeluaran', 'Hanya untuk Pengeluaran');

  Color get _accentColor => Colors.blue.shade700;
  Color get _lightColor => Colors.blue.shade50;
  IconData get _primaryIcon => Icons.trending_down_rounded;

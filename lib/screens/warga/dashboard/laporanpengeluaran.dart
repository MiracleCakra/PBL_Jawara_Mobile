...
class SemuaPengeluaranWargaScreen extends StatefulWidget {
  final String type = 'Pengeluaran';

  const SemuaPengeluaranWargaScreen({super.key});

  @override
  State<SemuaPengeluaranWargaScreen> createState() =>
      _SemuaPengeluaranWargaScreenState();
}

class _SemuaPengeluaranWargaScreenState extends State<SemuaPengeluaranWargaScreen>
  ...
  void _filterTransactions() {
    ...
    final filtered = _allTransactions.where((t) {
      // Filter berdasarkan tipe Pengeluaran
  ...
  Widget _buildTransactionCard(TransaksiModel item) {
    return InkWell(
      onTap: () =>
          context.push('/warga/keuangan/pengeluaran/detailpengeluaran', extra: item),
      child: Container(
          ...
          child: Row(
            children: [
              Container(
                ...
                child: Icon(Icons.trending_down_rounded, color: _iconColor, size: 24),
              ),
                      ...
                      Expanded(
                        child: ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                              backgroundColor: _primaryColor, // Warna primer ungu
                              padding: const EdgeInsets.symmetric(vertical: 14),
                              shape: RoundedRectangleBorder(
                                  borderRadius: BorderRadius.circular(12))),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Rincian ${widget.type}",
            style:
          ...
          child: Container(
            ...
            child: TabBar(
              ...
              indicator: BoxDecoration(
                color: _primaryColor, // Warna aktif (ungu)
                borderRadius: BorderRadius.circular(12),
              ),
